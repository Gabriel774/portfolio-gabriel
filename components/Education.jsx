        ...
        <section id='education' className={styles.education}>
            ...
            <div className={styles.desc}>
                <motion.h2
                    ...
                    whileInView={{ opacity: 1 }}
                    viewport={{ once: true, amount: 0.3 }}>
                    Aqui você pode conferir as principais formações e cursos que completei ou estou cursando,
                    procuro sempre estudar algo novo e avançar em minha jornada no universo da programação.
                </motion.h2>
                <motion.span
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
